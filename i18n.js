...
var LANG={
  zh:{
    ...
    gaPrediction:'預測成人身高',gaPredictionNote:'（依台灣兒童遺傳身高公式，由父母身高推估，僅供參考）',
  ...
  en:{
    ...
    gaPrediction:'Predicted Adult Height',gaPredictionNote:'(estimated from parents\' height using the Taiwan genetic-height formula, for reference only)',
